...
TEXTS = {
    "de": {
        ...
        "lizenz.gesperrt_hinweis": "Für den Suchlauf wird eine gültige Lizenz benötigt. Bitte unter Hilfe → Lizenz … einen gültigen Schlüssel eingeben.",
    ...
    "en": {
        ...
        "lizenz.gesperrt_hinweis": "A valid license is required to run a search. Please enter a valid key under Help → License …",
